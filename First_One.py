def first():
    ...
    df_machul = pd.read_excel("C:\\Users\\Jaeri\\Downloads\\song_sale.xls",header=10)
    df_machul.rename(columns={'업체(M)':'업체'}, inplace=True)
    df_machul = df_machul[(df_machul.업체.str.contains('Z')) == True]
    df_machul = df_machul.sort_values(by=['일자','업체','증표번호'])  # 여러열 오름 차순으로 정리 하기
    df_machul = df_machul[df_machul.특이사항 != 'ABC']
    df_machul.to_excel("C://Users//Jaeri//Downloads//song_sale.xlsx")

    wb1 = openpyxl.load_workbook("C://Users//Jaeri//Downloads//song_sale.xlsx")
    wb2 = openpyxl.load_workbook("C://Users//Jaeri//Downloads//eCount 자료입력 Data.xlsx")
    ws1 = wb1.active
    ws2 =wb2['1_구매입력']
    ws3 =wb2['1_품목 등록']
    ws4 =wb2['1_판매입력']
    ...
    for row in ws1.iter_rows(min_row=2):
        ...
        aa +=1
    wb1.close()
    wb2.save("C://Users//Jaeri//Downloads//eCount 입력 Data.xlsx")
    wb2.close()
    print("작업종료")

    print("모든 작업을 종료 합니다")
    
    os.startfile("C://Users//Jaeri//Downloads//eCount 입력 Data.xlsx")
